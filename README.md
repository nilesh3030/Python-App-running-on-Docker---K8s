...
This app has already been packed into a docker images and have been uplaoded pulically on the docker hub. One can pull the image directly from the docker hub and run it on kubernets or any other enviornment.
